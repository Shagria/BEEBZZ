...
$googleClientID = '823290211558-opnv75gi2d8lketc6ajg1bf5h887gfl5.apps.googleusercontent.com';
$googleClientSecret = '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';
...
if (!isset($_GET['action'])) {
    if (!empty($_SESSION['user_id'])) {
        ...
        $result = $usersDatabase->getUSer($email);
        if ($result == NULL) {
            $usersDatabase->insertUser('', '', $email, $password, '', '', '', '', '');
        }
