...
if(isset($_GET['sorted'])){
    $sorted = $_GET['sorted'];
    $products = $productDatabase->fetchSorted($category,$sorted,$start, $rows_per_page);
}else{
    ...
    <div class="filters container">
        <div class="row">
            <form action="./eshop.php" method="GET">
                ...
                <input type="text" name="price_from" min="0" value="<?php echo @$price_from ?>">
                <label for="">To:</label>
                <input type="text" name="price_to" min="0" value="<?php echo @$price_to ?>">
        ...
        <div class="row">
            <a href="eshop.php?category=<?php echo $category ?>&sorted=ASC"><button class="btn btn-light" style="display:inline-block; margin-bottom: 5px;">FROM LOWEST PRICE</button></a>
            <a href="eshop.php?category=<?php echo $category ?>&sorted=DESC"><button class="btn btn-light" style="display:inline-block;">FROM HIGHEST PRICE</button></a>
        </div>
    </div>
    <?php if (!empty($errors)) : ?>
        <div class="container">
